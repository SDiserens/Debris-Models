...
void WriteSimulationData(string scenario, Json::Value & config, double epoch, string collisionModel, Json::Value & collisionConfig, string propagatorType,
						 Json::Value & propagatorConfig, string breakUpType, Json::Value & fragmentationConfig, vector<tuple<int, double, int, tuple<int, int, int>, int, tuple<int, int, int, int>>> simulationLog);
